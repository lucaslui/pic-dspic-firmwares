...
// ==================================================================================================================
                               ...
                               // Definições da configuração do hardware com as PORTs I/O:
#define Pinos_Controle PORTB   // 	   <- Barramento de dados do display
#define Pino_RS 0              // 	   <- Número da entrada/saída correspondente ao pino RS do display.
#define Pino_EN 3 	       // 	   <- Número da entrada/saída correspondente ao pino EN do display.
...
char ConverterNumeroParaCaracter(char numero) // Função conversora de uma unidade númerica para o caracter correspondente.
{
  switch (numero)
  {
  case 0:
